 ...
 * Domain / URL / Address
 */
define('WP_FS__ROOT_DOMAIN_PRODUCTION', '#');
define('WP_FS__DOMAIN_PRODUCTION', '#');
define('WP_FS__ADDRESS_PRODUCTION', '#');

if (!defined('WP_FS__DOMAIN_LOCALHOST')) {
    define('WP_FS__DOMAIN_LOCALHOST', '#');
}
if (!defined('WP_FS__ADDRESS_LOCALHOST')) {
    define('WP_FS__ADDRESS_LOCALHOST', '#');
}

if (!defined('WP_FS__TESTING_DOMAIN')) {
    define('WP_FS__TESTING_DOMAIN', '#');
}
...
if (!defined('WP_FS__API_ADDRESS_LOCALHOST')) {
    define('WP_FS__API_ADDRESS_LOCALHOST', '#');
}
if (!defined('WP_FS__API_SANDBOX_ADDRESS_LOCALHOST')) {
    define('WP_FS__API_SANDBOX_ADDRESS_LOCALHOST', '#');
}
...
if (!defined('FS_CHECKOUT__ADDRESS_PRODUCTION')) {
    define('FS_CHECKOUT__ADDRESS_PRODUCTION', '#');
}

if (!defined('FS_CHECKOUT__ADDRESS_LOCALHOST')) {
    define('FS_CHECKOUT__ADDRESS_LOCALHOST', '#');
}

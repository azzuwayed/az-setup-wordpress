...
abstract class Freemius_Abstract
{
	 ...
	 * @return bool
	 */
	function is_plan__premium_only($plan, $exact = true)
	{
		return ($this->is_premium() && $this->is_plan($plan, true));
	}
	 ...
	 * @return bool
	 */
	function is_plan_or_trial__premium_only($plan, $exact = true)
	{
		return ($this->is_premium() && $this->is_plan_or_trial($plan, true));
	}
